...
const Contact = () => {
    return (
        <section className="bg-blue-50 dark:bg-slate-800 w-screen h-screen" id="contact">
            <Navbar />
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mb-4">
                    <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                        ...
                        <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">I can also put something here
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2">
                        <div className="h-full pr-6">
                            <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                I can put something here if you want
                            </p>
                            <ul className="mb-6 md:mb-0">
                                <li className="flex">
                                    ...
                                    <div className="ml-4 mb-4">
                                        ...
                                        <p className="text-gray-600 dark:text-slate-400">123 Richperson Dr</p>
                                        <p className="text-gray-600 dark:text-slate-400">Norwalk CT, 06854</p>
                                    </div>
                                </li>
                                <li className="flex">
                                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                    ...
                                    <div className="ml-4 mb-4">
                                        ...
                                        <p className="text-gray-600 dark:text-slate-400">Mobile: +1 (000) 000-0000</p>
                                        <p className="text-gray-600 dark:text-slate-400">Mail: contact@scarleestyles.com</p>
                                    </div>
                                </li>
                                <li className="flex">
                                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
